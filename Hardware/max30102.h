...
#define		MAX30102_IIC_SCL_PIN		GPIO_Pin_12
#define		MAX30102_IIC_SDA_PIN		GPIO_Pin_13

#define 	MAX30102_IIC_SCL				PBout(12)
#define 	MAX30102_IIC_SDA				PBout(13)
#define 	MAX30102_READ_SDA   		PBin(13)  //输入SDA 

#define		MAX30102_INT_CLK				RCC_APB2Periph_GPIOB
#define		MAX30102_INT_PORT				GPIOB
#define		MAX30102_INT_PIN		    GPIO_Pin_15
#define		MAX30102_INT            PBin(15)
